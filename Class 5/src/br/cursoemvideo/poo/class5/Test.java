...
public class Test {
	...
	public static void main(String[] args) {
		...
		boolean exit = false;
		int menu;
		System.out.println("Para abrir uma conta no banco NILBA digite o nome do responsável");
		String responsavel = scan.nextLine();
		Bank conta = new Bank(responsavel);
		
		do {
			System.out.println("\n\n*****Seja bem vindo ao menu do banco Nilba Sr.(ª) "+ responsavel + "*****");
			System.out.println("Aqui você pode:\n"
					+ "1 - Ativar sua conta\n"
			...
			System.out.println("Escolha uma opção do menu digitando o numero do item desejado");
			menu = scan.nextInt();
			switch (menu) {
			...
			case 2: //Encerrar a conta
				System.out.println("Você tem certeza que deseja encerrar a conta de responsável: " + conta.getResponsavel());
			...
			default:
				System.out.println("****Opção não reconhecida****\nSelecione uma opção que esteja no menu!!!");
				break;
			}
		}while(!exit);
	}
